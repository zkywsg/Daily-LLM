...
class DepthwiseSeparableConv(nn.Module):
    """DepthwiseSeparableConv · . · 深度可分离卷积 · 依赖: torch"""
...
>
> → 下一阶段：[语言线 — 序列建模与 Transformer](../../language/README.md)

---

**上一章**：[GAN 进阶](../gan-advanced/README.md) | **下一阶段**：[语言线](../../language/README.md)
