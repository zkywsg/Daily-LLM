...
> Dropout 的原理、inverted dropout 公式、变体（DropConnect / SpatialDropout / DropBlock / RNN Dropout）详见前置章节 [正则化与 Dropout](../../../foundations/deep-learning/regularization/README.md)。
...
class RegularizedNet(nn.Module):
    """RegularizedNet · . · BN+Dropout 示例 · 依赖: torch"""
...
**上一章**：[深度学习基础](../../../foundations/deep-learning/deep-learning-basics/README.md) | **下一章**：[CNN 架构](../cnn-architectures/README.md)
