...
| ReLU 全面普及 | Hinton et al. | 取代 sigmoid/tanh，梯度流动恢复，训练速度提升数倍 | [00·前置·激活函数](../00-Prerequisites/activation-functions/) |
...
| LSTM 序列建模 | Graves | 用 LSTM 生成手写字迹，证明循环网络可以建模长时序依赖 | [02·语言线·RNN](../02-Language-Transformers/recurrent-networks/) |
...
| GRU | Cho et al.（Montreal） | 简化 LSTM，两个门替代三个，计算更高效，序列建模新选择 | [02·语言线·RNN](../02-Language-Transformers/recurrent-networks/) |
...
| char-rnn / 语言生成 | Karpathy | LSTM 字符级语言模型，展示 RNN 惊人的文本生成能力 | [02·语言线·RNN](../02-Language-Transformers/recurrent-networks/) |
...
| CycleGAN | Zhu et al.（UC Berkeley） | 无配对图像翻译，循环一致性损失摆脱配对数据束缚 | [01·视觉线](../01-Visual-Intelligence/) |
...
| StyleGAN | Karras et al.（NVIDIA） | Mapping Network + AdaIN 分层风格控制，照片级面部生成 | [01·视觉线](../01-Visual-Intelligence/) |
