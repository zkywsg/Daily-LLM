export const CONSTITUTIONAL_AI_SOURCE_PATH = "12-rlhf-alignment/03-constitutional-ai.md";
...
const H2_KEYS: Array<{ test: RegExp; key: keyof ProseSections | "_coreInsight" }> = [
  ...
  { test: /^Constitution 长什么样/, key: "mechanism1" },
  { test: /^机制二/, key: "mechanism2" },
  { test: /^机制三/, key: "mechanism3" },
  { test: /^三件套协同/, key: "synergy" },
  { test: /^RLAIF vs RLHF 性能对比/, key: "performance" },
  { test: /^Anthropic 体系/, key: "claudeLineage" },
