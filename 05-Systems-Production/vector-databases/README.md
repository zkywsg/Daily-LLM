...
> 这一技术的遗产：向量数据库让语义检索成为基础设施级的标准化能力；但长向量、高并发、实时更新与成本控制的复合压力，仍是超大规模场景下持续优化的方向。
→ 详见 [智能体](../agents/README.md)

---

**上一章**: [RAG 基础](../rag-foundations/README.md) | **下一章**: [智能体](../agents/README.md)
