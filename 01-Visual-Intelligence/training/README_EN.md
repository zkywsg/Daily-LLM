...
> For the principles of Dropout, the inverted dropout formula, and variants (DropConnect / SpatialDropout / DropBlock / RNN Dropout), see the prerequisite chapter [Regularization & Dropout](../../00-Prerequisites/regularization/README_EN.md).
...
class RegularizedNet(nn.Module):
    """RegularizedNet · 01-Visual-Intelligence/training · BN+Dropout demo · deps: torch"""
...
class Net(nn.Module):
    """Net · 01-Visual-Intelligence/training · production-grade training demo · deps: torch"""
...
**Previous**: [Deep Learning Basics](../../00-Prerequisites/deep-learning-basics/README_EN.md) | **Next**: [CNN Architectures](../cnn-architectures/README_EN.md)
