...
class DepthwiseSeparableConv(nn.Module):
    """DepthwiseSeparableConv · 01-Visual-Intelligence/lightweight-vision · Depthwise separable conv · Dependencies: torch"""
...
class SEBlock(nn.Module):
    """SEBlock · 01-Visual-Intelligence/lightweight-vision · Channel attention · Dependencies: torch"""
...
class MobileNetTiny(nn.Module):
    """MobileNetTiny · 01-Visual-Intelligence/lightweight-vision · Lightweight classifier · Dependencies: torch"""
...
class SEResBlock(nn.Module):
    """SEResBlock · 01-Visual-Intelligence/lightweight-vision · SE residual block · Dependencies: torch"""
...
>
> → Next phase: [Language Line — Sequence Modeling & Transformers](../../02-Language-Transformers/README_EN.md)
