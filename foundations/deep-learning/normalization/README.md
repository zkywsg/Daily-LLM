...
```python
# 实现含 running stats 的简化 BatchNorm
# 训练时 EMA 更新，推理时使用累积统计
# 验证训练/推理模式切换行为
import numpy as np
...
```python
# 验证 PyTorch nn.BatchNorm1d 的 running stats
# 对比训练与推理模式的输出差异
# 理解 BatchNorm 的状态切换
import torch
...
**上一章**：[激活函数家族](../activation-functions/README.md) | **下一章**：[残差连接](../residual-connections/README.md)
