...
|------|------------------------|-------------------|--------|
| Dropout | Hinton group (Toronto) | Random deactivation prevents overfitting; standard regularization for deep learning established | [00·Prerequisites·Regularization](../foundations/deep-learning/regularization/) |
| ReLU widespread adoption | Hinton et al. | Replaced sigmoid/tanh, restored gradient flow, training speed increased several-fold | [00·Prerequisites·Activation Functions](../foundations/deep-learning/activation-functions/) |
| GPU deep learning ecosystem | NVIDIA / Krizhevsky | CUDA accelerates deep network training; computational infrastructure paradigm established | [00·Prerequisites](../foundations/) |
| ImageNet LSVRC | Stanford / Princeton | Established the most important visual benchmark of the deep learning era, driving annual competition | [00·Prerequisites](../foundations/) |
| Deep learning speech recognition | Hinton + Google/MS | DNN first large-scale industrial validation on ASR, error rate dropped 20%+ | [01·Vision Line](../tracks/vision/) |
| Data augmentation | Krizhevsky et al. | Random crop / flip / color jitter; standard practice for training large models with less data | [00·Prerequisites](../foundations/) |
| Max Pooling standardization | — | Spatial downsampling + translation invariance; standard component of CNN architecture | [01·Vision Line](../tracks/vision/) |
| Local Response Normalization | Krizhevsky | Lateral inhibition mechanism; normalization method before BN appeared | [01·Vision Line](../tracks/vision/) |
| DBN → CNN paradigm shift | Hinton | End of unsupervised pre-training era; end-to-end supervised training becomes mainstream | [01·Vision Line](../tracks/vision/) |
| CNN feature visualization | — | Understanding what each CNN layer learns; starting point for interpretability research | [01·Vision Line](../tracks/vision/) |
...
| Work | Proposer / Institution | Core Contribution | Module |
|------|------------------------|-------------------|--------|
| VAE | Kingma & Welling | Learning continuous latent variables via variational inference; mathematical foundation for generative models | [01·Vision Line](../tracks/vision/) |
| ZFNet | Zeiler & Fergus (NYU) | Deconvolution visualization of CNNs; won ILSVRC 2013; beginning of CNN interpretability | [01·Vision Line](../tracks/vision/) |
| Network in Network | Lin et al. | 1×1 conv + Global Avg Pooling; influenced all subsequent architectures including Inception and ResNet | [01·Vision Line](../tracks/vision/) |
| DropConnect | Wan et al. (NYU) | Random zeros on weights rather than activations; generalization variant of Dropout | [00·Prerequisites·Regularization](../foundations/deep-learning/regularization/) |
| Maxout Networks | Goodfellow et al. | Piecewise linear activation; can theoretically approximate any convex function; first major work by GAN authors | [01·Vision Line](../tracks/vision/) |
| DeepFace | Taigman et al. (Facebook) | Deep learning face recognition first surpasses human level (LFW 97.35%) | [01·Vision Line](../tracks/vision/) |
| LSTM sequence modeling | Graves | Using LSTM to generate handwriting; proving recurrent networks can model long-term temporal dependencies | [02·Language Line·RNN](../tracks/language/recurrent-networks/) |
| DQN precursor | Mnih et al. (DeepMind) | CNN + Q-learning plays Atari; seed paper for deep reinforcement learning | [00·Prerequisites](../foundations/) |
| Negative Sampling | Mikolov et al. | Word2Vec training acceleration trick; makes large vocabulary training feasible on CPU | [02·Language Line](../tracks/language/) |
| GloVe research started | Pennington et al. (Stanford) | Global co-occurrence matrix word vectors; formally published in 2014 | [02·Language Line](../tracks/language/) |
...
| Work | Proposer / Institution | Core Contribution | Module |
|------|------------------------|-------------------|--------|
| VGGNet | Simonyan & Zisserman (Oxford) | Uniform stacking of 3×3 convolutions; proving depth > width; classic backbone for transfer learning | [01·Vision Line](../tracks/vision/) |
| GoogLeNet / Inception | Szegedy et al. (Google) | Inception module with multi-scale parallel convolutions; ILSVRC 2014 champion | [01·Vision Line](../tracks/vision/) |
| Adam Optimizer | Kingma & Ba (OpenAI/Amsterdam) | Adaptive learning rate + momentum; almost no tuning needed to converge; becomes default deep learning optimizer | [01·Vision Line](../tracks/vision/) |
| GloVe | Pennington et al. (Stanford) | Global co-occurrence matrix word vectors; complementary to Word2Vec; more stable downstream performance | [02·Language Line](../tracks/language/) |
| GRU | Cho et al. (Montreal) | Simplified LSTM; two gates replace three; more efficient computation; new option for sequence modeling | [02·Language Line·RNN](../tracks/language/recurrent-networks/) |
| Dropout in RNNs | Zaremba et al. (NYU) | Solves RNN overfitting; makes LSTM language model training more stable | [00·Prerequisites·Regularization](../foundations/deep-learning/regularization/) |
| Neural Turing Machine | Graves et al. (DeepMind) | Neural network with external read-write memory; early Agent idea and RAG prototype | [05·Systems & Production](../tracks/systems/) |
| FaceNet | Schroff et al. (Google) | Triplet Loss face embedding; technical foundation for large-scale industrial face recognition deployment | [01·Vision Line](../tracks/vision/) |
| Deep Learning (book) | Bengio, Goodfellow, Courville | First systematic textbook in the deep learning field; establishes the discipline's knowledge system | [00·Prerequisites](../foundations/) |
| DCGAN concept萌芽 | — | Accumulation of GAN training techniques; laying groundwork for DCGAN in 2015 | [01·Vision Line](../tracks/vision/) |
...
| Work | Proposer / Institution | Core Contribution | Module |
|------|------------------------|-------------------|--------|
| ResNet | He et al. (MSRA) | 152-layer residual network; Top-5 error rate 3.57% below human; skip connections solve degradation | [01·Vision Line](../tracks/vision/) |
| Batch Normalization | Ioffe & Szegedy (Google) | Normalizes input distribution per layer; training speed increases by order of magnitude; allows higher learning rates; foundation for stable deep network training | [01·Vision Line](../tracks/vision/) |
| Highway Networks | Srivastava et al. (IDSIA) | Gated skip connections; direct precursor to ResNet; earliest solution to network degradation | [01·Vision Line](../tracks/vision/) |
| DQN (Nature version) | Mnih et al. (DeepMind) | First heavyweight result of deep reinforcement learning; surpasses humans on 57 Atari games | [00·Prerequisites](../foundations/) |
| Faster R-CNN | Ren et al. (MSRA) | Region proposal network unifies detection pipeline; standard paradigm for object detection established | [01·Vision Line](../tracks/vision/) |
| U-Net | Ronneberger et al. (Freiburg) | Encoder-decoder + skip connections; classic architecture for medical image segmentation | [01·Vision Line](../tracks/vision/) |
| DCGAN | Radford et al. (OpenAI) | Convolutional GAN + training stability tricks; first reproducible method for generating realistic images | [01·Vision Line](../tracks/vision/) |
| Neural Style Transfer | Gatys et al. (Tübingen) | Content / style disentanglement transfer; generative AI first breaks into mainstream public awareness | [01·Vision Line](../tracks/vision/) |
| Deep Speech 2 | Amodei et al. (Baidu) | End-to-end speech recognition; surpasses human level; industrial validation of big data + big models | [01·Vision Line](../tracks/vision/) |
| Spatial Transformer | Jaderberg et al. (DeepMind) | Learnable spatial transformations; gives networks geometric attention | [01·Vision Line](../tracks/vision/) |
| YOLO v1 | Redmon et al. | Single-stage real-time object detection; efficiency revolution; new option for industrial deployment | [01·Vision Line](../tracks/vision/) |
| char-rnn / text generation | Karpathy | LSTM character-level language model; demonstrating RNN's astonishing text generation ability | [02·Language Line·RNN](../tracks/language/recurrent-networks/) |
...
| Work | Proposer / Institution | Core Contribution | Module |
|------|------------------------|-------------------|--------|
| WaveNet | van den Oord et al. (DeepMind) | Autoregressive waveform generation; leap in speech synthesis quality; influences subsequent audio generation models | [01·Vision Line](../tracks/vision/) |
| FastText | Joulin et al. (Facebook) | Subword n-gram representations; extremely fast word vector training; suitable for low-resource languages | [02·Language Line](../tracks/language/) |
| DenseNet | Huang et al. (Cornell) | Each layer connects to all previous layers; maximizes feature reuse; extremely high parameter efficiency | [01·Vision Line](../tracks/vision/) |
| NAS | Zoph & Le (Google Brain) | Using RL to search network architectures; starting point for AutoML and LLM architecture design | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| A3C | Mnih et al. (DeepMind) | Asynchronous parallel Actor-Critic; breakthrough in RL training efficiency; foundational technology for RLHF | [00·Prerequisites](../foundations/) |
| OpenAI Gym | Brockman et al. (OpenAI) | Standardized RL environment interface; makes reinforcement learning research reproducible and comparable | [00·Prerequisites](../foundations/) |
| SqueezeNet | Iandola et al. (Berkeley) | 50× smaller than AlexNet with comparable accuracy; early representative of lightweight models | [01·Vision Line](../tracks/vision/) |
| Pointer Networks | Vinyals et al. (Google) | Attention directly points to input positions; solves variable-length structured output problems | [02·Language Line](../tracks/language/) |
| SSD Object Detection | Liu et al. | Multi-scale feature map real-time detection; new benchmark for precision-speed balance | [01·Vision Line](../tracks/vision/) |
| OpenAI founded | OpenAI | Non-profit AI safety research institution founded; institutional starting point of the GPT series | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
...
| Work | Proposer / Institution | Core Contribution | Module |
|------|------------------------|-------------------|--------|
| AlphaGo Zero | Silver et al. (DeepMind) | Pure self-play without human game records; ultimate proof of RL bootstrapping capability | [00·Prerequisites](../foundations/) |
| PPO | Schulman et al. (OpenAI) | Proximal policy optimization; core algorithm for RLHF; OpenAI's main RL tool | [00·Prerequisites](../foundations/) |
| MobileNet | Howard et al. (Google) | Depthwise separable convolution; efficiency benchmark for mobile deep learning | [01·Vision Line](../tracks/vision/) |
| SE-Net | Hu et al. | Channel attention plug-and-play module; ILSVRC 2017 champion | [01·Vision Line](../tracks/vision/) |
| Focal Loss / RetinaNet | Lin et al. (Facebook) | Solves class imbalance; single-stage detection performance catches up to two-stage | [01·Vision Line](../tracks/vision/) |
| Capsule Networks | Hinton et al. (Google) | Dynamic routing replaces pooling; challenges CNN spatial representation | [01·Vision Line](../tracks/vision/) |
| Progressive GAN | Karras et al. (NVIDIA) | Progressive resolution generation; milestone for high-quality face images | [01·Vision Line](../tracks/vision/) |
| CycleGAN | Zhu et al. (UC Berkeley) | Unpaired image translation; cycle consistency loss frees from paired data constraints | [01·Vision Line](../tracks/vision/) |
| PyTorch mainstream | Paszke et al. (Facebook) | Dynamic graph framework becomes research standard; influences deep learning ecosystem for 10 years | [00·Prerequisites](../foundations/) |
| Soft Actor-Critic | Haarnoja et al. (Berkeley) | Maximum entropy RL; high sample efficiency benchmark for continuous control tasks | [00·Prerequisites](../foundations/) |
| Multi-head attention theory | — | Empirical research begins on Transformer heads attending to different linguistic structures | [02·Language Line](../tracks/language/) |
...
| Work | Proposer / Institution | Core Contribution | Module |
|------|------------------------|-------------------|--------|
| ELMo | Peters et al. (AllenAI) | Bidirectional LSTM context word vectors; dynamic representation of polysemy; BERT precursor | [02·Language Line](../tracks/language/) |
| ULMFiT | Howard & Ruder (Fast.ai) | Language model pre-training + discriminative fine-tuning; earliest systematic validation of NLP transfer learning | [02·Language Line](../tracks/language/) |
| GLUE Benchmark | Wang et al. (NYU et al.) | Unifies 9 NLP task evaluations; drives pre-trained models into NLP mainstream | [02·Language Line](../tracks/language/) |
| Transformer-XL | Dai et al. (Google/CMU) | Segment-level recurrence mechanism; breaks fixed context length; direct precursor to XLNet | [02·Language Line](../tracks/language/) |
| OpenAI Five (Dota 2) | OpenAI | RL defeats professional players in high-complexity multiplayer games; large-scale RL system validation | [00·Prerequisites](../foundations/) |
| BigGAN | Brock et al. (DeepMind) | Large-batch GAN training; image quality and diversity greatly improved | [01·Vision Line](../tracks/vision/) |
| StyleGAN | Karras et al. (NVIDIA) | Mapping Network + AdaIN layered style control; photo-realistic face generation | [01·Vision Line](../tracks/vision/) |
| PyTorch 1.0 official | Paszke et al. (Facebook) | Production-grade dynamic graph framework release; research-industry unification; main competitor to TensorFlow | [00·Prerequisites](../foundations/) |
| SNAIL | Mishra et al. (Berkeley) | Temporal convolution + attention meta-learning; new idea for few-shot learning | [00·Prerequisites](../foundations/) |
| XLNet research started | Yang et al. (CMU/Google) | Permutation language model idea formed; formally surpasses BERT the next year | [02·Language Line](../tracks/language/) |
| BERT Chinese version | Google | BERT multilingual support; NLP pre-training expands to global languages | [02·Language Line](../tracks/language/) |
...
| Work | Proposer / Institution | Core Contribution | Module |
|------|------------------------|-------------------|--------|
| XLNet | Yang et al. (CMU/Google) | Permutation language model; simultaneously obtains bidirectional context; comprehensively surpasses BERT | [02·Language Line](../tracks/language/) |
| ALBERT | Lan et al. (Google) | Parameter sharing + factorized embeddings; 18× smaller than BERT-large with no performance drop | [02·Language Line](../tracks/language/) |
| DistilBERT | Sanh et al. (HuggingFace) | Knowledge distillation compresses BERT to 60%; 60% faster inference; starting point for lightweight NLP | [02·Language Line](../tracks/language/) |
| Sparse Transformer | Child et al. (OpenAI) | Sparse attention patterns; reduces long-sequence self-attention from O(n²) | [02·Language Line](../tracks/language/) |
| Megatron-LM | Shoeybi et al. (NVIDIA) | Model-parallel training framework; 8.3B parameters; large-scale distributed training infrastructure | [05·Systems & Production](../tracks/systems/) |
| HuggingFace Transformers | Wolf et al. (HuggingFace) | Unified pre-trained model ecosystem; becomes the de facto standard platform for open-source NLP | [02·Language Line](../tracks/language/) |
| ERNIE (Baidu) | Sun et al. (Baidu) | Knowledge-enhanced pre-training; integrates knowledge graph into BERT; Chinese NLP milestone | [02·Language Line](../tracks/language/) |
| MoCo | He et al. (Facebook) | Momentum contrastive learning; validates feasibility of self-supervised visual representation learning | [00·Prerequisites](../foundations/) |
| GPT-2 full open source | OpenAI | Eventually open-sources 1.5B version; validates the value of open-source large models for community momentum | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| SuperGLUE | Wang et al. | Harder NLP evaluation set than GLUE; drives models to surpass human benchmarks | [02·Language Line](../tracks/language/) |
...
| Work | Proposer / Institution | Core Contribution | Module |
|------|------------------------|-------------------|--------|
| Vision Transformer (ViT) | Dosovitskiy et al. (Google) | Pure Transformer processes image patches; breaks CNN monopoly on vision | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| AlphaFold 2 | Jumper et al. (DeepMind) | Protein structure prediction rivaling experimental precision; AI for Science milestone | [00·Prerequisites](../foundations/) |
| RAG paper | Lewis et al. (Facebook) | Retrieval + generation combined; alleviates hallucination + knowledge cutoff; RAG direction formally proposed | [05·Systems & Production](../tracks/systems/) |
| Switch Transformer | Fedus et al. (Google) | Mixture of Experts MoE; breaks trillion parameters with same compute; precursor to MoE mainstream | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| SimCLR | Chen et al. (Google) | Contrastive learning self-supervised pre-training; matures unsupervised visual representation learning | [00·Prerequisites](../foundations/) |
| Big Bird | Zaheer et al. (Google) | Sparse global attention; 4096-token long document understanding Transformer | [02·Language Line](../tracks/language/) |
| ELECTRA | Clark et al. (Google/Stanford) | Replaced token detection training objective; more efficient alternative pre-training scheme to BERT | [02·Language Line](../tracks/language/) |
| DALL-E research started | OpenAI | Text-to-image generation technology accumulation;蓄水期 for multimodal LLMs | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| GPT-3 API public beta | OpenAI | LLM provided as API service; starting point for commercial AI application ecosystem | [05·Systems & Production](../tracks/systems/) |
| Chinchilla precursor research | DeepMind | Early research on training efficiency vs. data volume; lays foundation for 2022 Chinchilla paper | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
...
| Work | Proposer / Institution | Core Contribution | Module |
|------|------------------------|-------------------|--------|
| DALL-E | Ramesh et al. (OpenAI) | First high-quality text-to-image model; multimodal generation enters public awareness | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| AlphaFold 2 published | Jumper et al. (DeepMind) | Nature official publication; opens 200 million protein structure prediction database | [00·Prerequisites](../foundations/) |
| FLAN (instruction tuning) | Wei et al. (Google) | Multi-task instruction data fine-tuning for LLMs; zero-shot capability greatly improved; ChatGPT precursor | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| InstructGPT research | Ouyang et al. (OpenAI) | RLHF alignment technology落地; GPT-3 aligns toward "helpful, harmless, honest" | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| WebGPT | Nakano et al. (OpenAI) | Let language models use search engines; early Tool Use / RAG prototype | [05·Systems & Production](../tracks/systems/) |
| Decision Transformer | Chen et al. (Berkeley/Google) | RL problem becomes sequence prediction; new paradigm for Transformer solving decision problems | [00·Prerequisites](../foundations/) |
| Gopher | Rae et al. (DeepMind) | 280B parameter language model; DeepMind enters the large model arms race | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| Perceiver IO | Jaegle et al. (DeepMind) | General architecture processing arbitrary modalities; early exploration of unified multimodal representation | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| GitHub Copilot public beta | GitHub / OpenAI | Codex-powered AI programming assistant; starting point for AI-ification of developer tools | [05·Systems & Production](../tracks/systems/) |
| Megatron-LM v2 | NVIDIA | Supports hundred-billion parameter model training; large-scale parallel training infrastructure matures | [05·Systems & Production](../tracks/systems/) |
...
| Work | Proposer / Institution | Core Contribution | Module |
|------|------------------------|-------------------|--------|
| PaLM | Chowdhery et al. (Google) | 540B parameters; first systematic study of Chain-of-Thought reasoning capability | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| DALL-E 2 | Ramesh et al. (OpenAI) | CLIP + diffusion model; image quality and controllability greatly improved | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| Whisper | Radford et al. (OpenAI) | Large-scale weakly supervised speech recognition; open-source multilingual ASR solution | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| Constitutional AI | Bai et al. (Anthropic) | Training AI with AI feedback; reducing human annotation; important variant of alignment methods | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| DPO | Rafailov et al. (Stanford) | Direct preference optimization; no separate reward model needed; more stable and concise than RLHF | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| Flamingo | Alayrac et al. (DeepMind) | Few-shot vision-language model; pioneer of multimodal In-Context Learning | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| OPT | Zhang et al. (Meta) | 175B parameter open-source language model; drives democratization of academic large model research | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| Minerva | Lewkowycz et al. (Google) | Math reasoning specialized LLM; explores LLM applications in STEM domains | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| Flash Attention | Dao et al. (Stanford) | IO-aware attention computation; 2–4× training speed; 5–20× memory savings | [05·Systems & Production](../tracks/systems/) |
| LLaMA research preparation | Meta | Efficiency-first route launched; smaller model + more data technical route | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
...
| Work | Proposer / Institution | Core Contribution | Module |
|------|------------------------|-------------------|--------|
| LLaMA 2 | Touvron et al. (Meta) | Officially open-sourced for commercial use; 7B/13B/70B; open-source LLM ecosystem fully explodes | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| Mistral 7B | Jiang et al. (Mistral AI) | Sliding window attention + GQA; 7B beats 13B; efficiency pushed to the extreme | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| Claude | Anthropic | Constitutional AI alignment; 100K long context; commercial closed-source competition | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| Code Llama | Rozière et al. (Meta) | Code-specialized large model; new benchmark for open-source code generation | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| ReAct / Chain-of-Thought | Yao et al. | Reasoning + action loop framework; theoretical foundation for Agent engineering | [05·Systems & Production](../tracks/systems/) |
| AutoGPT | Toran Bruce Richards | Let LLM autonomously decompose and execute multi-step tasks; Agent breaks into mainstream awareness | [05·Systems & Production](../tracks/systems/) |
| LangChain / LlamaIndex | Open-source community | RAG and Agent engineering frameworks; LLM application development infrastructure takes shape | [05·Systems & Production](../tracks/systems/) |
| Mixtral 8x7B | Mistral AI | Open-source MoE; 46B parameters but only 13B activated; high efficiency and high quality combined | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| Llama 2 Chat | Meta | RLHF-aligned Llama 2; new benchmark for open-source dialogue models | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| GPT-4 Technical Report | OpenAI | Detailed disclosure of training process and capability evaluation; drives entire industry benchmarking | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
...
| Work | Proposer / Institution | Core Contribution | Module |
|------|------------------------|-------------------|--------|
| Claude 3 series | Anthropic | Haiku/Sonnet/Opus tiers; long context + multimodal; leading alignment capability | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| GPT-4o | OpenAI | Unified multimodal (text/image/voice); real-time interaction; end-to-end training | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| Sora | Liu et al. (OpenAI) | Text-to-high-quality-long-video generation; prototype of world model; video generation milestone | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| Llama 3 | Meta | 8B/70B open-source; code and reasoning ability greatly improved; new open-source benchmark | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| DeepSeek V2/V3 | DeepSeek | Efficient open-source MoE architecture; extremely high cost-performance; challenges closed-source top models | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| Qwen 2 series | Alibaba | Full series open-source; multilingual; sign of mature Chinese LLM open-source ecosystem | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| Gemma | Google | Small open-source models; research-friendly; supports edge device deployment | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| vLLM / PagedAttention | Kwon et al. (Berkeley) | LLM inference service efficiency revolution; throughput improved 24×; becomes serving infrastructure | [05·Systems & Production](../tracks/systems/) |
| Flash Attention 2/3 | Dao et al. | Further improves attention computation efficiency; supports longer context training | [05·Systems & Production](../tracks/systems/) |
| RLVR | — | Training reasoning with verifiable rewards (math/code results); technical route decomposition of o1 | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
...
| Work | Proposer / Institution | Core Contribution | Module |
|------|------------------------|-------------------|--------|
| o3 / o4-mini | OpenAI | Further improved reasoning ability; ARC-AGI approaching human level; reasoning model ceiling | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| Claude 3.5 / 3.7 | Anthropic | Extended Thinking; Hybrid reasoning mode | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| Llama 4 | Meta | MoE architecture + native multimodal; new breakthrough for open-source flagship | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| Gemini 2.0 | Google | Native multimodal + Agent capability; 2M tokens long context | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| Test-Time Compute Scaling | — | Inference-time compute scaling laws; alongside training-time Scaling Laws as two major laws of AI | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| Multimodal Agent maturation | — | Vision + language + tool calling unified; computer-operation Agent enters usable stage | [05·Systems & Production](../tracks/systems/) |
| Benchmark失效 crisis | — | MMLU/HumanEval and other mainstream evaluation sets approach saturation; new generation evaluation system reconstruction | [05·Systems & Production](../tracks/systems/) |
| Speculative Decoding普及 | — | Draft model + verification model parallel; LLM inference speed 2–3× improvement | [05·Systems & Production](../tracks/systems/) |
| Reasoning budget control | — | Allocate "thinking budget"; avoid model over-reasoning; new direction for inference efficiency | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
| Long-chain reasoning reliability research | — | Deep reasoning on wrong premises amplifies bias; new challenge for AI safety and alignment | [03·Scale & Multimodal](../tracks/scale-multimodal/) |
...
|--------|------------------------|
| [00·Prerequisites](../foundations/) | Neural network foundations |
| [01·Vision Line](../tracks/vision/) | 2012–2017 CNN · RNN · Generative models |
| [02·Language Line](../tracks/language/) | 2013–2019 Word vectors · Attention · BERT |
| [03·Scale & Multimodal](../tracks/scale-multimodal/) | 2020–2021 GPT-3 · ViT · CLIP |
| [04·Alignment & Open Source](../tracks/alignment/) | 2022–2023 RLHF · DPO · LLaMA |
| [05·Systems & Production](../tracks/systems/) | 2023–2025 RAG · Agent · Reasoning · MLOps |
| [06·Capstone Projects](../projects/) | Cross-phase synthesis |
